          ...
          >
            <Tab eventKey="Scalping" title="Scalping">
              {plansData.loading ? (
                ...
                <div className="allplan-grid">
                  {plansData.data.map((plan, index) => {
                    const hasMultipleOptions = plan["Option Strategy"]?.length > 1;
                    const isOptionsExpanded = expandedOptions.includes(index);

                    const hasMultiplePatterns = plan.Pattern?.length > 1;
                    const isPatternsExpanded = expandedPatterns.includes(index);

                    return (
                      <div key={index} className="allplan-card">
                        <div className="plan-data text-center">
                          ...
                          <h4 className="allplan-card-subtitle">Number of Script: {plan.NumberofScript}</h4>

                          <div className="plan-details">
                            <p className="price-item">
                              <strong>Scalping Strategy:</strong> {plan?.Scalping?.join(", ") || "N/A"}
                            </p>
                            <p className="price-item">
                              <strong>Options:</strong>
                              {hasMultipleOptions ? (
                            ...
                            <p className="price-item">
                              ...
                              {hasMultiplePatterns ? (
                                <>
                                  {isPatternsExpanded ? plan.Pattern.join(", ") : plan.Pattern[0]}
                                  <span className="show-more" onClick={() => togglePatterns(index)}>
                                    {isPatternsExpanded ? " 🔼" : " 🔽"}
                                  </span>
                                </>
                              ) : (
                                plan.Pattern?.join(", ") || "N/A"
                              )}
                            </p>
                          </div>
