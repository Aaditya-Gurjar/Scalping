...
// ----backup code for new tradehistory page ______
...
//   // from date default remains currentDate; to date is tomorrow
...
//   const [getFiveLossTrade, setFiveLossTrade] = useState({ data: [] });
//   const [getFiveProfitTrade, setFiveProfitTrade] = useState({ data: [] });
...
//   // Fetch strategy types and trade history
//   useEffect(() => {
//     const fetchData = async () => {
//       try {
//         const strategyRes = await getStrategyType();
//         setStrategyNames(strategyRes.Data || []);
//         const tradeRes = await get_User_Data({
//           Data: selectStrategyType,
//           Username,
//         });
//         setTradeHistory({
//           data: tradeRes?.Data || [],
//           data1: tradeRes?.NewScalping || [],
//         });
//       } catch (error) {
...
//               ? "NewScalping"
//               : "Scalping",
//           Strategy: selectedRowData?.Targetselection || "Scalping",
//           Symbol: selectedRowData?.Symbol || "",
//           ETPattern: selectedRowData?.TType || "",
//           Group: selectedRowData?.GroupN || "",
//         };
//       case "Option Strategy":
//         return {
//           ...baseParams,
//           MainStrategy: "Option Strategy",
//           Strategy: selectedRowData?.STG || "",
//           Symbol: selectedRowData?.IName || "",
...
//           Strategy: selectedRowData?.TradePattern || "",
//           Symbol: selectedRowData?.Symbol || "",
//           ETPattern: selectedRowData?.Pattern || "",
...
//           Strategy: selectedRowData?.Targetselection || "",
//           Symbol: selectedRowData?.TSymbol || "",
//           ETPattern: "",
//         };
//       default:
//         return baseParams;
...
//   const handleSubmit = async () => {
//     if (!selectedRowData) {
//       Swal.fire("Warning", "Please select a row first!", "warning");
//       return;
//     }
//     try {
//       const params = getStrategySpecificParams();
//       const tradeRes = await get_Trade_History(params);
//       setAllTradeData({
//         data: tradeRes.data || [],
...
//     } catch (error) {
//       Swal.fire("Error", "Failed to load trade data", "error");
//     }
//   };
...
//     switch (selectStrategyType) {
//       case "Scalping":
//         return tableType === "MultiCondition" ? columns() : columns1();
//       case "Option Strategy":
//         return columns1();
...
//             <button
//               className="btn btn-primary btn-lg modern-submit-btn"
...
//                   <h5 className="m-0">Total Profit/Loss Overview</h5>
//                 </div>
//                 <div className="card-body">
...
//               <div className="card mb-4">
//                 <div className="card-header">
//                   <h5 className="m-0">Profit/Loss Analysis</h5>
//                 </div>
//                 <div className="card-body">
//                   <ProfitAndLossGraph data={getPnLData.data} />
//                 </div>
