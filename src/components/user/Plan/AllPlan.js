...
// __________________________________<Latest>____________________________________
                ...
                <Tab eventKey="Scalping" title="Scalping">
                    <div className="allplan-grid">
                        {plansData.loading ? (
                            ...
                            getUpdatedPlans?.length === 0 ? (
                                <div className="allplan-card no-plans-card">
                                    <h2 className="allplan-card-title">No Plans Available</h2>
                                    <p className="allplan-card-message">
                                ...
                                getUpdatedPlans?.map((plan, index) => (
                                    <div key={index} className="allplan-card">
                                        ...
                                        <div className="plan-details">
                                            ...
                                            <p>
                                                <strong>Options:</strong> {plan["Option Strategy"]?.join(", ")}
                                            </p>
                                            <p>
                            ...
                            getUpdatedPlansCharting?.length === 0 ? (
                                ...
                                getUpdatedPlansCharting?.map((plan, index) => (
                                    <div key={index} className="allplan-card">
                                        ...
                                        <div className="plan-details">
                                            <p>
                                                <strong>Charting Signals:</strong> {plan.ChartingSignal?.join(", ")}
                                            </p>
                                        </div>
                                        {isPlanPurchased(plan.PlanName) ? (
                                            <button
