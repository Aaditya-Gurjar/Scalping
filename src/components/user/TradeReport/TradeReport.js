...
//         }
//         setSelectedRowData(""); // Clear selected row when switching strategy types
//         setCheckedRows(null); // Clear checked rows
...
//                     });
//                     setShowTable(true); // Show table if data exists
//                 } else {
//                     setOpenCloseChartingData({ CloseData: [], OpenData: [] });
//                     setShowTable(false); // Hide table to show <NoDataFound />
//                 }
//             })
//             .catch((err) => {
